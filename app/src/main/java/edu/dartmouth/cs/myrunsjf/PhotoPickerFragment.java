...
public class PhotoPickerFragment extends DialogFragment {
    ...
    public static final String TAG = "PhotoPickerFragment.java";
    ...
    public static final int ID_PHOTO_PICKER_FROM_LIBRARY = 1;

    private static final String DIALOG_ID_KEY = "dialog_id";

    public static PhotoPickerFragment newInstance(int dialog_id) {
        PhotoPickerFragment frag = new PhotoPickerFragment();
            ...
            case DIALOG_ID_PHOTO_PICKER:
                ...
                DialogInterface.OnClickListener dlistener = new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        ((UserProfilePreferences) parent).changeImage(item);
                    }
                };

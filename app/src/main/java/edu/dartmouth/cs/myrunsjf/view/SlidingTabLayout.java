...
package edu.dartmouth.cs.myrunsjf.view;
...
import edu.dartmouth.cs.myrunsjf.HistoryFragment;
import edu.dartmouth.cs.myrunsjf.MainActivity;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public static final String TAG = "SlidingTabLayout.java";
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            // CHECK IF HISTORY TAB IS IN VIEW
            if (position == 1) {
                Log.d(TAG, "HISTORY TAB IS IN VIEW");
                MainActivity activity = (MainActivity) mTabStrip.getContext();
                HistoryFragment fragment = (HistoryFragment) activity.getFragments().get(1);
                fragment.updateView();
            }
        }
